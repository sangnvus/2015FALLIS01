...
namespace TaxiApp
{
    public partial class RiderAddWorkPlace : PhoneApplicationPage
    {
        public RiderAddWorkPlace()
        {
            InitializeComponent();
        }
        ...
        private void txt_Address_Copy_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
