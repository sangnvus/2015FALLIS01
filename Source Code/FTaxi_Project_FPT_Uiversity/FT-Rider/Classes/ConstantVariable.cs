...
namespace FT_Rider.Classes
{
    class ConstantVariable
    {
        ...
        public const string tNetRiderRateTrip = "http://123.30.236.109:8088/TN/restServices/TripController/RateTrip"; 
        ...
        public const string DUPLICATED = "Tải khoản này đã tồn tại, vui lòng chọn tài khoản khác.";
        public const string DUPPLICATED_PHONE_NUMBER = "Số điện thoại đã được đăng ký, vui lòng nhập số điện thoại khác";
